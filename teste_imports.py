...
# Passo 2: Testar listar_quintas()
print("\n2️⃣ Testando listar_quintas()...")
try:
...
# Passo 3: Import quintas_updater
print("\n3️⃣ Importando quintas_updater...")
try:
...
# Passo 4: Teste de atualização (dry-run)
print("\n4️⃣ Testando atualizar_quinta() [dry-run]...")
try:
